...
const UpdatePost = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try{
            const response = await fetch(`/api/post/update-post/${formData._id}/${currentuser._id}`, {
                method: 'PUT',
                headers: {
  ...
  return (
    <div className='p-3 max-w-3xl mx-auto min-h-screen'>
        ...
        <form className='flex flex-col space-y-5 gap-4' onSubmit={handleSubmit}>
            ...
            <ReactQuill theme='snow' id='content' placeholder='Write something amazing...' className='h-72 mb-12' required
